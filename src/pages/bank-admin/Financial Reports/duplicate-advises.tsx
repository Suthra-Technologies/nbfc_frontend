                ...
                <Card className="flex-1 border-[#e2e8f0] shadow-sm bg-white overflow-hidden rounded-md min-h-[500px]">
                    <div className="h-full w-full flex items-center justify-center text-[#94a3b8]">
                        <div className="text-center space-y-2">
                            <p className="text-sm font-medium italic">Enter a Journal Voucher number and click Print to view the advice.</p>
                            <p className="text-xs opacity-70">Generates a duplicate copy for archival/reference purposes.</p>
                        </div>
                    </div>
                </Card>
